...
rLayer = 'D:/studies/phd/WV3_Data_July2019/010039360030_01/L_Sabie_subset/L_sabie_subset_img.tif'
vLayer = 'D:/studies/phd/WV3_Data_July2019/010039360030_01/L_Sabie_subset/mapping land cover/Lcover_train_and_test.shp'


def rasterize(raster_ext, shp, attrib = 'C_ID'):
...
#reshape array data 
x_img_arr = x_img_arr.reshape(1550*1950,8)
...
train_img, test_img, train_lab, test_lab = train_test_split(all_data_img, all_data_lab, train_size = 0.7, random_state = 90)
